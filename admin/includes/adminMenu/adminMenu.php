...
class WPM2AWS_AdminMenu
{
    ...
    protected function addSubmenuCreateStaging($isAvailable, $parentSlug)
    {
        ...
        add_submenu_page(
            ...
            function () use ($menuSlug, $isAvailable) {
                ...
                $this->loadAwsCreateStaging($isAvailable);
            }
        );
    }
    ...
    public function loadAwsConsole()
    {
        ...
        if ($validLicence === false || $validLicence === '') {
            ...
            WPM2AWS_AdminPagesGeneral::makeRegisterTrialSection();
            WPM2AWS_AdminPagesGeneral::makeLoadingOverlaySection();
     ...
     * @return void
     */
    public function loadAwsCreateStaging($isAvailable)
    {
        WPM2AWS_AdminPagesConsole::loadAwsCreateStagingView($isAvailable);
    }
