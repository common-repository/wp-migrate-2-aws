...
class WPM2AWS_ApiRemote
{
    ...
    public function createLightsailFromZip()
    {
        ...
        if ($isError === true) {
            ...
            $adminFunctions->wpm2awsLogBadRemoteConnection($responseCode, $errorMessage, 'createLightsailFromZip - Error: WP::112');
        ...
        if ('200' !== $responseCode && 200 !== $responseCode) {
            ...
            if ((int)$responseCode >= 500 && (int)$responseCode < 600) {
                ...
                $adminFunctions = new WPM2AWS_AdminFunctions();
                $adminFunctions->wpm2awsLogBadRemoteConnection($responseCode, $errorMessage, 'createLightsailFromZip - Error: WP::126');
