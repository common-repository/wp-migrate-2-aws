...
//     }
    ...
    public function getRemoteConsoleData()
    {
        ...
        if ($isError === true) {
            ...
            $adminFunctions->wpm2awsLogBadRemoteConnection('n/a', $errorMessage, 'getRemoteConsoleData');
        ...
        if ('200' !== $responseCode && 200 !== $responseCode) {
            ...
            if ((int)$responseCode >= 400 && (int)$responseCode < 500) {
                ...
                if ((int)$responseCode >= 500 && (int)$responseCode < 600) {
                    $adminFunctions = new WPM2AWS_AdminFunctions();
                    $adminFunctions->wpm2awsLogBadRemoteConnection($responseCode, $errorMessage, 'getRemoteConsoleData');
                }
    ...
    public function remoteAddNewMetricAlarm($alarmName, $metric, $comparitor, $triggerPoint, $threshold, $timePeriods)
    {
        ...
        if ($isError === true) {
            ...
            $adminFunctions = new WPM2AWS_AdminFunctions();
            $errorMessage = $response->get_error_message();
            $adminFunctions->wpm2awsLogBadRemoteConnection('n/a', $errorMessage, 'remoteAddNewMetricAlarm');
            return array( 'error' => 'An Error Has Occurred (data)<br>Please contact <a href="' . WPM2AWS_SEAHORSE_WEBSITE_URL . '/wp-on-aws-support-portal/" target="_blank">Seahorse Support</a>', 'code' => 'error');
        }
        ...
        if ('200' !== $responseCode && 200 !== $responseCode) {
            ...
            if ((int)$responseCode >= 400 && (int)$responseCode < 500) {
                ...
                if ((int)$responseCode >= 500 && (int)$responseCode < 600) {
                    $adminFunctions = new WPM2AWS_AdminFunctions();
                    $adminFunctions->wpm2awsLogBadRemoteConnection($responseCode, $errorMessage, 'remoteAddNewMetricAlarm');
                }
    ...
    public function remoteRebootInstance()
    {
        ...
        if ($isError === true) {
            ...
            $adminFunctions = new WPM2AWS_AdminFunctions();
            $errorMessage = $response->get_error_message();
            $adminFunctions->wpm2awsLogBadRemoteConnection('n/a', $errorMessage, 'remoteRebootInstance');
        ...
        if ('200' !== $responseCode && 200 !== $responseCode) {
            ...
            if ((int)$responseCode >= 400 && (int)$responseCode < 500) {
                ...
                if ((int)$responseCode >= 500 && (int)$responseCode < 600) {
                    $adminFunctions = new WPM2AWS_AdminFunctions();
                    $adminFunctions->wpm2awsLogBadRemoteConnection($responseCode, $errorMessage, 'remoteRebootInstance');
                }
    ...
    public function remoteCreateManualSnapshot($snapShotName)
    {
        ...
        if ($isError === true) {
            ...
            $adminFunctions = new WPM2AWS_AdminFunctions();
            $errorMessage = $response->get_error_message();
            $adminFunctions->wpm2awsLogBadRemoteConnection('n/a', $errorMessage, 'remoteCreateManualSnapshot');
            throw new \Exception( 'An error has occurred.<br>Please contact <a href="' . WPM2AWS_SEAHORSE_WEBSITE_URL . '/wp-on-aws-support-portal/" target="_blank">Seahorse Support</a>');
        }
        ...
        if ('200' !== $responseCode && 200 !== $responseCode) {
            ...
            if ((int)$responseCode >= 400 && (int)$responseCode < 500) {
                ...
                if ((int)$responseCode >= 500 && (int)$responseCode < 600) {
                    $adminFunctions = new WPM2AWS_AdminFunctions();
                    $adminFunctions->wpm2awsLogBadRemoteConnection($responseCode, $errorMessage, 'remoteCreateManualSnapshot');
                }
    ...
    public function remoteChangeInstancePlan($planId, $snapShotName)
    {
        ...
        if ($isError === true) {
            ...
            $adminFunctions = new WPM2AWS_AdminFunctions();
            $errorMessage = $response->get_error_message();
            $adminFunctions->wpm2awsLogBadRemoteConnection('n/a', $errorMessage, 'remoteChangeInstancePlan');
            throw new \Exception( 'An error has occurred.<br>Please contact <a href="' . WPM2AWS_SEAHORSE_WEBSITE_URL . '/wp-on-aws-support-portal/" target="_blank">Seahorse Support</a>');
        }
        ...
        if ('200' !== $responseCode && 200 !== $responseCode) {
            ...
            if ((int)$responseCode >= 400 && (int)$responseCode < 500) {
                ...
                if ((int)$responseCode >= 500 && (int)$responseCode < 600) {
                    $adminFunctions = new WPM2AWS_AdminFunctions();
                    $adminFunctions->wpm2awsLogBadRemoteConnection($responseCode, $errorMessage, 'remoteChangeInstancePlan');
                }
